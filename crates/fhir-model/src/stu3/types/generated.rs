...
/// Reference wrapper type of the valueSet field in DataRequirementCodeFilter
#[derive(Debug, Clone, Serialize, Deserialize)]
...
impl PartialEq for DataRequirementCodeFilterValueSetReference {
    fn eq(&self, other: &Self) -> bool {
        self.reference == other.reference
    }
}
...
/// Reference wrapper type of the valueSet field in ElementDefinitionBinding
#[derive(Debug, Clone, Serialize, Deserialize)]
...
impl PartialEq for ElementDefinitionBindingValueSetReference {
    fn eq(&self, other: &Self) -> bool {
        self.reference == other.reference
    }
}
...
impl PartialEq for ParameterDefinitionProfileReference {
    fn eq(&self, other: &Self) -> bool {
        self.reference == other.reference
    }
}
...
impl PartialEq for RelatedArtifactResourceReference {
    fn eq(&self, other: &Self) -> bool {
        self.reference == other.reference
    }
}
...
/// Reference wrapper type of the eventTiming field in TriggerDefinition
#[derive(Debug, Clone, Serialize, Deserialize)]
...
impl PartialEq for TriggerDefinitionEventTimingReference {
    fn eq(&self, other: &Self) -> bool {
        self.reference == other.reference
    }
}
